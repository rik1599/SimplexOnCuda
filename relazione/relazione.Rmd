...
Di seguito si nota come il tempo medio per una singola esecuzione del ciclo varia al variare della dimensione della matrice.
...
```
Si può notare come il tempo per singolo ciclo cresce non linearmente all'aumentare della dimensione del problema, come possibile intuire dall'introduzione teorica all'algoritmo, inoltre all'aumentare della dimensione del problema si nota come anche la differenza di tempo necessario per l'esecuzione del ciclo tra schede video con diverse prestazioni tende ad aumentare.
