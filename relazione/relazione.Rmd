...
```{r, echo=FALSE, warning=FALSE}
  ...
  par(mfrow=c(1,2))
  plot(data = phaseOneMean_ElemNumber, log(values)~log(cells), main = "Fase 1")
...
plot(data = mx250.means, log(values)~log(cells), main = "Tempo medio per singolo ciclo di solve in fase 1", xlab = "numero di elementi del tableau", ylab = "Tempo per ciclo", col = "black")
