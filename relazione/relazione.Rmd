...
Questa sezione si concentra nell'analizzare le prestazioni ottenute con diverse gpu e la conseguente scalabilità delle performance in base alle prestazioni del dispostivo utilizzato
...
```
Si può notare come all'aumentare della dimensione del problema la differenza di tempo necessario per l'esecuzione del ciclo tra schede video con diverse prestazioni tende ad aumentare.
